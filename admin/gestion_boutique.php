...
if(isset($_GET['action']) && $_GET['action'] == "affichage")
{
  ...
  while($ligne = $resultat->fetch_assoc())
    ...
    $contenu .= '<td><a href="?action=modification&id_produit='.$ligne['id_produit'] .'"><img src="../inc/img/edit-button.svg"></a></td>';
    $contenu .= '<td><a href="?action=suppression&id_produit='.$ligne['id_produit'] .'" OnClick="return(confirm(\'En êtes vous certain ?\'));"><img src="../inc/img/delete.svg"></a></td>';
    $contenu .= '</tr>';
    }
